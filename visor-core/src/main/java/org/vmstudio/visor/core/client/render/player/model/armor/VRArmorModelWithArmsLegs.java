...
public class VRArmorModelWithArmsLegs<T extends LivingEntity> extends VRArmorModelWithArms<T> implements FeetModel {
    ...
    public static MeshDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        boolean connected = VRClientSettings.isPlayerLimbsConnected();
        int upperExtension = connected ? VRPlayerModelWithArmsLegs.UPPER_EXTENSION : 0;
        int lowerExtension = connected ? VRPlayerModelWithArmsLegs.LOWER_EXTENSION : 0;
