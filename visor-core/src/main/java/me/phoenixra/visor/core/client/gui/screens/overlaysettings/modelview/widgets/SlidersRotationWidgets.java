...
public class SlidersRotationWidgets extends WidgetSet {
    ...
    public SlidersRotationWidgets(OptionsScreenModelView owner) {
    ...
    public List<AbstractWidget> initWidgets(int edgeX, int edgeY, int edgeWidth, int edgeHeight) {
        ...
        sliderRotationX = SliderValueWidget.builder()
                ...
                .setTooltip(Tooltip.create(Component.translatable("visor.overlaySettings.modelView.widget.sliderRotationX")))
                .setOnValueChange(it->{
        ...
        sliderRotationY = SliderValueWidget.builder()
                ...
                .size(100, 15)
                .setSnapIncrement(0.001f)
                .setTooltip(Tooltip.create(Component.translatable("visor.overlaySettings.modelView.widget.sliderRotationY")))
                .setOnValueChange(it->{
        ...
        sliderRotationZ = SliderValueWidget.builder()
                ...
                .size(100, 15)
                .setSnapIncrement(0.001f)
                .setTooltip(Tooltip.create(Component.translatable("visor.overlaySettings.modelView.widget.sliderRotationZ")))
                .setOnValueChange(it->{
