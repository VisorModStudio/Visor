...
public abstract class VisorRenderer implements IVisorRenderer {
    ...
    public void createTargets() throws Throwable {
        ...
        for (VRDisplay renderStage : list) {
            VisorClient.LOGGER.info("Passes: " + renderStage.toString());
        }
        ...
        VRGuiManager guiManager = ClientContext.visor.getGuiManager();
        ...
        VisorClient.LOGGER.info("[Visor] render targets created:" +
    ...
    public void prepareReinit(@NotNull String cause) {
        if (!reinitTargets) {
            ...
            VisorClient.LOGGER.info("Reinit Render Buffers: {}", cause);
        }
    ...
    public void prepareResize(@NotNull String cause) {
        if (!this.resizeTargets) {
            // only print the initial cause
            VisorClient.LOGGER.info("Resizing Render Buffers: {}", cause);
        }
