...
import me.phoenixra.visor.core.client.render.gameview.registry.VRHandItemPoseRegistry;
...
public class VRHandRenderer implements IVRHandRenderer {
    ...
    public void renderSimpleHands(@NotNull PoseStack poseStack, float partialTicks, boolean renderMain,
        ...
        if (renderMain && ClientContext.rawPlayerPose
                .getControllerRightData()
                .isTracking()) {
            renderSimpleHand(ControllerHand.MAIN, partialTicks, poseStack);
        }
        if (renderOffhand && ClientContext.rawPlayerPose
                .getControllerLeftData()
                .isTracking()) {
