...
import me.phoenixra.visor.core.client.tasks.types.game.movement.TaskInputRotation;
import org.joml.Vector2f;

import java.util.Map;

public class ActionRotate extends VisorActionVec2 {
    ...
    public ActionRotate(VisorActionSet actionSet) {
        super(actionSet, ID);
    }
