...
public class TexturedSelectionList extends AbstractSelectionList<TexturedSelectionList.TexturedEntry> {
    ...
    public class TexturedEntry extends Entry<TexturedEntry> {
        ...
        public void renderBack(@NotNull GuiGraphics guiGraphics,
            ...
            GuiTexture texture = widgetInfo.getTextureEntry();
            if (Objects.equals(getSelected(), this)) {
                texture = widgetInfo.getTextureEntryHoveredSelected();
                if(!hovering || texture == null) {
                    texture = widgetInfo.getTextureEntrySelected();
                }
            } else if (hovering) {
                texture = widgetInfo.getTextureEntryHovered();
            }
            texture.blit(
                    guiGraphics,
                    getRowLeft(), top,
