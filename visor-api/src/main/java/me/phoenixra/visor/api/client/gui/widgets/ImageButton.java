...
public class ImageButton extends AbstractButton {
    ...
    @Getter
    private final WidgetInfoButton widgetInfo;
    ...
    public ImageButton(WidgetInfoButton widgetInfo,
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        int textW = getWidth() + widgetInfo.getTextScaleOffset().x;
        int textH = getHeight() + widgetInfo.getTextScaleOffset().y;
        if (!text.isEmpty()) {
